    ...
    <div className="relative isolate overflow-hidden bg-[#060b16] text-slate-100">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 h-[56rem] overflow-hidden">
          ...
          <div className="absolute inset-x-0 top-[-5rem] h-[66rem]">
      ...
      <div className="relative z-10">
        ...
        <main
          id="main-content"
          className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-10 px-5 pb-20 pt-24 sm:px-8 sm:pt-28 md:gap-12 lg:px-14 lg:gap-16 lg:pb-24"
        >
          <Hero />
          <ProjectsSection />
          <SectionDivider />
